...
#сначала опишем основную функцию
...
def get_weather(city, start_date, end_date):
    '''Эта функция создает прогноз погоды:
    Принимает на вход:
    - название города
    - даты начала и конца путешествия
    Возвращает:
    - таблицу с прогнозом - тип df - название forecast - содержит дату, температуру, икноку и описание погоды на каждый день
    - общий вывод о погоде на все время путешествия - тип str - название final'''
